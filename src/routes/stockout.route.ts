...
import { createStockout, deleteStockout, getAllStockouts, getSumOfStockout } from "../controllers/stockout.controller";
...
router.delete("/:id",protectRoute([RoleEnum.ADMIN, RoleEnum.MANAGER, RoleEnum.OFFICER]),deleteStockout);
