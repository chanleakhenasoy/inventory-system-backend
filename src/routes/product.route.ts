...
import { createProduct, deleteProduct, getAllProduct, getProductById, getProductdatabase, getTotalProduct, updateProduct } from "../controllers/product.controller";
...
router.get("/product-database", protectRoute([RoleEnum.ADMIN, RoleEnum.MANAGER, RoleEnum.OFFICER]), getProductdatabase);
